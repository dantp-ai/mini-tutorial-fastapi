...
@api.get("/", name="Check the health status of the API.")
async def get_status():
    return {"message": "healthy"}


@api.get("/questions", name="Get a random set of multiple-choice questions.")
...
@api.post("/question", name="Create a new question")
